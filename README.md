...
> Check the [official documentation]([https://tauri.app/v1/guides/testing/webdriver/introduction](https://v2.tauri.app/develop/tests/webdriver/)) for more information.
